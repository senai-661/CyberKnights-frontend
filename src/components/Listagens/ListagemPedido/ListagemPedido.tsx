    ...
    return (
        <main className="bg-gray-200 h-[76vh]"> {/* Web Semântica SEO (Search Engine Optimizer) */}
            <div className="w-8/10 flex m-auto p-12">
                <h1 className="w-9/10 text-3xl text-center">Pedidos</h1>
                ...
                <table className="table-auto w-full border-collapse text-sm">
                    <thead className="bg-slate-700 sticky top-0 z-10">
                        <tr>
                            ...
                            <th className="border border-slate-600 text-white p-4">ID Cliente</th>
                            <th className="border border-slate-600 text-white">ID Produto</th>
                            <th className="border border-slate-600 text-white">ID Pedido</th>
                            <th className="border border-slate-600 text-white">Valor</th>
                            <th className="border border-slate-600 text-white">Status Pedido</th>
